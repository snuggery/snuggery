...
describe('YamlFileHandle', () => {
	...
	describe('updating', () => {
		it('should work when passed a no-op', async () => {
		...
		it('should transform aliases into merges', async () => {
			await expect(
				updateString(
					stripIndent`
						lorem:
		...
		it('should handle changes on merged objects', async () => {
			await expect(
				updateString(
					stripIndent`
						lorem:
